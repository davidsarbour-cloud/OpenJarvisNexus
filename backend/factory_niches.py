...
POD_DESIGNS: list[dict] = [
    ...
    # FLUX as ILLUSTRATIVE art (no slogans/text — FLUX renders text poorly; keep
    # designs graphic). Each: key, tier, label, product, art_prompt (print-ready),
    # tags (seed keywords for the listing).
    # ── S-Tier — proven Etsy POD sellers ─────────────────────────────────────
    {"key": "garden_floral", "tier": "S", "label": "Garden Era Floral", "product": "t-shirt",
     "art_prompt": "vintage garden floral illustration, soft muted botanical bouquet, delicate wildflowers, cottage aesthetic, isolated on transparent background, centered, print-ready apparel graphic, high detail",
     "tags": ["floral", "botanical", "cottagecore", "vintage", "garden", "womens tshirt"]},
    {"key": "coffee_cozy", "tier": "S", "label": "Coffee & Cozy", "product": "t-shirt",
     "art_prompt": "cozy autumn illustration, steaming coffee cup with books and a knit blanket, warm muted tones, cute flat illustration, isolated on transparent background, centered, print-ready",
     "tags": ["coffee", "cozy", "autumn", "fall", "book lover", "gift"]},
    {"key": "celestial_mystic", "tier": "S", "label": "Celestial Mystique", "product": "t-shirt",
     "art_prompt": "celestial mystical illustration, crescent moon with stars and sun, fine gold line art, boho mystic, isolated on transparent background, centered, print-ready",
     "tags": ["celestial", "moon", "mystical", "boho", "stars", "witchy"]},
    {"key": "cottagecore_mush", "tier": "S", "label": "Cottagecore Mushrooms", "product": "t-shirt",
     "art_prompt": "cottagecore mushrooms and wildflowers illustration, soft pastel forest scene, whimsical botanical, isolated on transparent background, centered, print-ready",
     "tags": ["cottagecore", "mushroom", "forest", "botanical", "whimsical", "nature"]},

    # ── A-Tier — strong demand ───────────────────────────────────────────────
    {"key": "retro_sunset", "tier": "A", "label": "Retro Sunset", "product": "t-shirt",
     "art_prompt": "70s retro sunset with warm horizontal stripes, vintage muted palette, minimalist landscape badge, isolated on transparent background, centered, print-ready",
     "tags": ["retro", "70s", "sunset", "vintage", "nature", "minimalist"]},
    {"key": "luna_moth", "tier": "A", "label": "Luna Moth Celestial", "product": "t-shirt",
     "art_prompt": "luna moth with crescent moon and botanicals, symmetrical mystical illustration, muted earth tones, isolated on transparent background, centered, print-ready",
     "tags": ["luna moth", "celestial", "moth", "boho", "nature", "mystical"]},
    {"key": "kawaii_cat", "tier": "A", "label": "Kawaii Cats", "product": "t-shirt",
     "art_prompt": "kawaii cute cat illustration, pastel, simple rounded shapes, playful, isolated on transparent background, centered, print-ready",
     "tags": ["cat", "kawaii", "cute", "pastel", "cat lover", "gift"]},
    {"key": "floral_skull", "tier": "A", "label": "Floral Skull", "product": "t-shirt",
     "art_prompt": "skull surrounded by flowers, boho dark floral illustration, fine line art, muted palette, isolated on transparent background, centered, print-ready",
    ...
    {"key": "mountain_adventure", "tier": "A", "label": "Mountain Adventure", "product": "t-shirt",
     "art_prompt": "minimalist mountain and pine forest landscape badge, outdoorsy retro illustration, muted tones, isolated on transparent background, centered, print-ready",
     "tags": ["mountain", "adventure", "outdoors", "hiking", "nature", "camping"]},

    # ── B-Tier ───────────────────────────────────────────────────────────────
    {"key": "groovy_daisy", "tier": "B", "label": "Groovy Daisy", "product": "t-shirt",
     "art_prompt": "retro groovy smiling daisies, 70s funky flower pattern, warm palette, isolated on transparent background, centered, print-ready",
     "tags": ["groovy", "daisy", "retro", "70s", "flower", "hippie"]},
    {"key": "abstract_organic", "tier": "B", "label": "Abstract Organic", "product": "t-shirt",
     "art_prompt": "modern abstract organic shapes, matisse-style cut-outs, muted earthy palette, minimalist art, isolated on transparent background, centered, print-ready",
